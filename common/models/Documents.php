...
class Documents extends ActiveRecord
{
    ...
    {
        $kategoria = (Nehnutelnost::findOne([
            'id' => (ZmluvaNehnutelnost::getNehnutelnostId($contract_id))]))
            ->kategoria;
        $sql = "
            SELECT
                nd.zmluva_id,
    ...
    {
        $kategoria = (Nehnutelnost::findOne(['id' => (ZmluvaNehnutelnost::getNehnutelnostId($contract_id))]))
            ->kategoria;
        $sql = "
            SELECT 
