...
class CestneVyhlasenieSpolocnikaTemplate extends PdfTemplateDocument
{
    const TEMPLATE_ID = 478;
    private $date;
    private $town;
    private $companyInfo;
