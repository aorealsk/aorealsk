...
$this->title = $lang === 'hu' ? 'Sikeres hitelesítés' : 'Úspešná validácia';
    ...
    <section id="contact-section-one">
        <div class="contactus-form" style="margin-top: 0px; width: 50%; margin-bottom: 50px;">
            <div class="wpcf7" id="wpcf7-f2130-o1" lang="en-US" dir="ltr">
                ...
                <p>
                    <?php if ($lang === 'sk'): ?>
                        Validácia Vášho prístupu na digitálny nápojový lístok bol úspešný. Na Váš e-mail sme poslali link, cez ktorý môžete
                        zrealizovať objednávky.
                    <?php endif; ?>
                    <?php if ($lang === 'hu'): ?>
                        Az Ön hozzáférésének hitelesítése sikeres volt. E-mail címére elküldtük a linket, amelyre kattintva itallapunkról rendelhet.
                    <?php endif; ?>
                </p>
                <br>
                <p>
