...
<main class="site-applicant">
	...
	<?php
        //  QR code *between* the banner and the form
        $qrFileLocal = __DIR__ . '/assets/finreq_qrcode.png'; // spr·vna cesta, folder 'assets'
        if (file_exists($qrFileLocal)) {
            // ak chcete priamo base64 (vnorenÈ) ó pouûite toto:
            // $qrData = base64_encode(file_get_contents($qrFileLocal));
            // echo Html::img('data:image/png;base64,' . $qrData, ['alt'=>'Financial QR','class'=>'qr-center']);

            // alebo bezpecnejöie: naservÌrovat ako URL (ked je v /web)
            echo Html::img(Url::to('@web/frontend/views/app-request-eng/assets/finreq_qrcode.png'), [
                'alt'   => 'Financial questionnaire QR code',
                'class' => 'qr-center'
            ]);
        } else {
            echo '<!-- QR not found: ' . Html::encode($qrFileLocal) . ' -->';
        }
        ?>
                ...
                <div class="form-group row">
                    <div class="col-md-12 col-xs-12">
                        ...
                        <p class="consent-note text-justify">
                            ...
                            <span class = "aoreal"> ALPHA-OMEGA REAL & CONSULTING s. r. o. </span>, <strong> with its registered office at ƒåerny≈°evsk√©ho 10, 851 01 Bratislava - Petr≈æalka district </strong>,
                ...
                <div class="form-group row">
                    <div class="col-md-12 col-xs-12">
                        <input
                                ...
                                placeholder="Amount of other regular monthly expenses in ‚Ç¨ (excluding housing expenses)"
...
$js = <<<JS
    ...
    $('#docup').on('click',function(){
        ...
        .done(function(resp){
           ...
           alert('V√°≈° dokument bol spracovan√Ω');
        });
    });
