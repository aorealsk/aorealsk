...
$clientZoneSubmenu=[
    ['label' => Yii::t('app','Prihlásiť sa'), 'url' => '/client/login'],
];

if (!Yii::$app->user->isGuest) {
    $clientZoneSubmenu=[
        ['label' => Yii::t('app','Môj profil'), 'url' => '/client/my-profile'],
        ['label' => Yii::t('app','Moje služby'), 'url' => '/client/my-services'],
        ['label' => Yii::t('app','Odhlásiť sa'), 'url' => '/client/logout'],
    ];
}
...
$menuItems = [
    ...
    [
        ...
        'submenu' => [
            ['label'=>Yii::t('app','Založenie firmy'),'url'=>'/dotaznik-zalozenie-sro'],
            ['label'=>Yii::t('app','Účtovníctvo'), 'url' => '/uctovnictvo'],
        ]
    ],
    ...
    [
        'label' => Yii::t('app','Zákaznícka zóna'),
        'url' => '#',
        'submenu' => $clientZoneSubmenu
    ],
