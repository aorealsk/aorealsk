...
$this->title = Yii::t('app','Zákaznícka zóna - aktivácia účtu');
    ...
    <section id="contact-section-one">
        <div class="contactus-form" style="margin-top: 0px; width: 50%; margin-bottom: 50px;">
            ...
            <div class="wpcf7" id="wpcf7-f2130-o1" lang="en-US" dir="ltr">
                ...
                <p>
                    <?= Yii::t('app','Vaša registrácia neprebehla úspešne. Dôvod: ') ?>
                </p>
                <h4>
                    <?php
                    /**
                     ...
                     */
                    $statusDescription = [
                        'invalid-key' => Yii::t('app','Chybný autorizačný kľúč'),
                        'client-not-found' => Yii::t('app','Klient nebol nájdený'),
                        'wrong-id' => Yii::t('app','Zlé Id')
                    ];
                    ?>
