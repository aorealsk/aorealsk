...
$this->title = Yii::t('app','Zákaznícka zóna');
        ...
        <div class="contactus-form" style="margin-top: 0px; width: 50%; margin-bottom: 50px;">
            ...
            <div role="form" class="wpcf7" id="wpcf7-f2130-o1" lang="en-US" dir="ltr">
                ...
                <div style="color:#999;margin:1em 0">
                    <?= Yii::t('app','V prípade straty hesla využite možnosť '.Html::a(Yii::t('app','Obnovy hesla'), ['/client/password-reset'])) ?>.
                    <?= Yii::t('app', 'Ešte nemáte vytvorené konto? '.Html::a(Yii::t('app','Zaregistrujte sa.'),['/client/signup'])) ?>
                </div>
