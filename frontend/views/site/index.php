...
V prípade akýchkoľvek otázok nás neváhajte kontaktovať na ktoromkoľvek z nižšie uvedených kontaktných údajov.</p></div>
	...
	<div id="training-speaking" class="d-block position-relative mx-auto" data-seq-src="/images/financne-poradenstvo-img-6.png">
		...
		<div class="container">
				...
				<div class="col-sm-12 col-lg-5 float-sm-none d-sm-inline-block align-bottom text-center text-sm-left text-lg-right" data-aios-staggered-parent="true" data-aios-animation-offset="0.2" data-aios-animation-reset="false">
					...
					<div class="training-speaking__description d-inline-block mt-10 mb-0 mt-md-10 text-center text-lg-right" data-aios-staggered-child="true" data-aios-animation="fadeInRight" data-aios-animation-delay="0s">
                        ...
                        <div class="video-player">
                            <!-- Youtube Video -->
							<iframe width="320" height="175" src="https://www.youtube.com/embed/_fystFKcmok" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
					</div>
				</div>
				<!-- END: Column -->
			...
			<div class="row mt-6">
				<!-- BEGIN: Column -->
				<div class="col-md-12 text-center text-lg-center" data-aios-staggered-parent="true" data-aios-animation-offset="0.2" data-aios-animation-reset="false">
					<a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl(['/hypokalkulacka']); ?>" class="secondary-button secondary-button-big secondary-button-reverse text-uppercase mx-2" data-aios-staggered-child="true" data-aios-animation="fadeInLeft" data-aios-animation-delay="0s">
						Hypokalkulačka
					</a>
					<a href="<?php echo Yii::$app->urlManager->createAbsoluteUrl(['/rezervacia-terminu']); ?>" class="secondary-button secondary-button-big secondary-button-reverse text-uppercase mx-2" data-aios-staggered-child="true" data-aios-animation="fadeInRight" data-aios-animation-delay="0s">
						Rezervácia termínu
					</a>
				</div>
				<!-- END: Column -->
