...
class SaveClientJobsAction extends Action
{
    ...
    public function run()
    {
        ...
        $clientReference = Yii::$app->request->post('client_reference');
        $pid = getmypid();
        ...
        try {
            ...
            SysLog::WriteInfo($pid, 'AppRequestController', 'Client Ref: ' . $clientReference);
        ...
        return [
            'status'=>'ok',
            'client_id'=>$clientId,
            'client_request_reference'=>$clientReference
        ];
    }
}