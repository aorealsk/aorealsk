 ...
 * @var $companies
 * @var $dokumenty
 * @var $chybajuce_dokumenty
 * @var $dodavatel_vody
 * @var $dodavatel_elektriny
 * @var $dodavatel_plynu
 * @var $dodavatel_tv
 * @var $olo
 * @var $predajcovia
 * @var $predvolby
 * @var $dodavatel_telefon
 * @var $titul_pred
 * @var $titul_za
 * @var $uto
 */
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                   <div class="row">
                       <div class="col-12">
                            <label class="control-label">Firmy:</label>
                            <select class="form-control form-select" id="doc-company-id">
                            <?php foreach ($companies as $it) : ?>
                    ...
                    <div class="col-12">
                           <button class="btn btn-info m-t-30 text-white" id="dalsie-udaje">Ďalšie údaje</button>
                           <button class="btn btn-success m-t-30 disabled text-white" id="gendoc">
                               Vygeneruj dokumenty
                           </button>
                           <a href="/backoffice/contracts" class="btn btn-danger m-t-30 text-white">
                               <i class="mdi mdi-rewind"></i> Späť
                           </a>
                   </div>
                                    ...
                                    for ($i = 0; $i < $c; $i++) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               <button
                                                       class="btn btn-info"
                                                       onclick="openCommentWindow()"> Pridať
                                               </button>
                                            </td>
                                            <td>
                                                <a
                    ...
                    <div
                            ...
                            tabindex="-1"
                            role="dialog"
                            aria-labelledby="otherDataModalLabel"
                            aria-hidden="true"
                    >
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="otherDataModalLabel">Ďalšie údaje</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a
                                                    ...
                                                    href="#nehnutelnost"
                                                    role="tab"
                                                    aria-controls="nehnutelnost"
                                                    aria-selected="false"
                                            >
                                                Nehnuteľnosť <sub class="small text-danger">(1)</sub>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a
                                                    ...
                                                    href="#predavajuci"
                                                    role="tab"
                                                    aria-controls="predavajuci"
                                                    aria-selected="false"
                                            >
                                                Predávajúci <sub class="small text-danger">(1,3,4)</sub>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a
                                                    ...
                                                    href="#kupujuci"
                                                    role="tab"
                                                    aria-controls="kupujuci"
                                                    aria-selected="false"
                                            >
                                                Kupujúci <sub class="small text-danger">(1,3,4)</sub>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a
                                                    class="nav-link"
                                                    id="splnomocnenec-tab"
                                                    data-toggle="tab"
                                                    href="#splnomocnenec"
                                                    role="tab"
                                                    aria-controls="splnomocnenec"
                                                    aria-selected="false"
                                            >
                                                Splnomocnenec <sub class="small text-danger">(2)</sub>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a
                                                    ...
                                                    aria-selected="false"
                                            >
                                                Dodávatelia <sub class="small text-danger">(2)</sub>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a
                                                    class="nav-link" id="financovanie-tab"
                                                    data-toggle="tab"
                                                    href="#financovanie"
                                                    role="tab"
                                                    aria-controls="financovanie"
                                                    aria-selected="false"
                                            >
                                                Financovanie <sub class="small text-danger">(4)</sub>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a
                                                    ...
                                                    href="#podpisy"
                                                    role="tab"
                                                    aria-controls="podpisy"
                                                    aria-selected="false"
                                            >
                                                Overenie podpisov <sub class="small text-danger"></sub>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a
                                                    class="nav-link"
                                                    id="preber-protokol-tab"
                                                    data-toggle="tab"
                                                    href="#preber-protokol"
                                                    role="tab"
                                                    aria-controls="preber-protokol"
                                                    aria-selected="false"
                                                    >
                                                Preberací protokol
                                            </a>
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div
                                                class="tab-pane fade show active m-l-10 m-r-10 m-b-10 m-t-20"
                                                id="nehnutelnost"
                                                role="tabpanel"
                                                aria-labelledby="nehnutelnost-tab"
                                        >
                                            <div class="row">
                                                <div class="col-md-12">Tu môžete nahrať nové LV</div>
                                            </div>
                                            <div class="row m-b-30">
                                                ...
                                                <div class="col-md-2">
                                                    <button
                                                        ...
                                                        <i class="mdi mdi-upload"></i> Nahrať
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="row">
                                        ...
                                        <div
                                                class="tab-pane fade m-l-10 m-r-10 m-b-10 m-t-20"
                                                id="predavajuci"
                                                role="tabpanel"
                                                aria-labelledby="predavajuci-tab">
                                            <?php
                                            foreach ($predajcovia as $i => $item) {
                                                ?>
                                            <h5 class="m-b-10">Predávajúci č. <?= $i + 1 ?></h5>
                                            <div class="row">
                                            ...
                                            <h5 class="sc-op-load-<?= $i + 1 ?>">
                                                Nahrajte občiansky preukaz predávajúceho
                                            </h5>
                                            <div class="row sc-op-load-<?= $i + 1 ?> m-b-20">
                                                ...
                                                <div class="col-sm-6">
                                                    <label
                                                            for="op-zadna"
                                                            class="form-control-label">Zadná strana
                                                    </label>
                                                    <input
                                                            type="file"
                                                            name="op_zadna"
                                            ...
                                            <div class="row m-t-10 sc-op-load-<?= $i + 1 ?> m-b-40">
                                                <div class="col-md-12">
                                                    <button
                                                            ...
                                                            id="repr-op"
                                                    >
                                                        <i class="mdi mdi-upload"></i> Nahrať OP
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-1 form-group">
                                                    ...
                                                    <select class="form-control select-drop" name="Dt[pr][][predv]">
                                                        <?php foreach ($predvolby as $pv) : ?>
                                                            <option value="<?= $pv['predvolba']?>">
                                                                +<?= $pv['predvolba'] ?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                ...
                                                <div class="col-md-5 form-inline">
                                                    ...
                                                    <select
                                                            class="form-control select-drop col-lg-2"
                                                            name="Dt[pr][][uto]"
                                                    >
                                                        <?php foreach ($uto as $ut) : ?>
                                                            <option value="<?=$ut['operator_kod'] ?>">
                                                                <?= $item['operator_kod'] ?>
                                                            </option>";
                                                        <?php endforeach; ?>
                                                    </select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <select class="form-control select-drop" name="Dt[pr][][titp]">
                                                        ...
                                                        <?php foreach ($titul_pred as $tit) : ?>
                                                            <option value="<?= $tit['short_name']?>">
                                                                <?= $tit['short_name']?>
                                                            </option>";
                                                        <?php endforeach; ?>
                                                    </select>
                                            ...
                                            <div class="row" id="sp-rp-<?= $i + 1 ?>">
                                                <div class="col-md-6 form-group">
                                                    <label class="control-label">Rodné priezvisko</label>
                                            ...
                                            <div class="row" id="sp-dat-<?= $i + 1 ?>">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    <label class="control-label">
                                                        Rodné číslo (zadajte bez lomitka)
                                                    </label>
                                            ...
                                            <div class="row" id="sp-op1-<?= $i + 1 ?>">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    <label class="control-label">OP vydal</label>
                                                    <input type="text" class="form-control" name="Dt[pr][][vydalop]">
                                                </div>
                                            </div>
                                            <div class="row" id="sp-op2-<?= $i + 1 ?>">
                                                <div class="col-md-6 form-group">
                                                    <label class="control-label">Dátum vydania</label>
                                                    <input type="date" class="form-control" name="Dt[pr][][datvyd]">
                                                </div>
                                                <div class="col-md-6 form-group">
                                                    <label class="control-label">Dátum platnosti</label>
                                                    <input type="date" class="form-control" name="Dt[pr][][datplat]">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 form-group">
                                                    <label class="control-label">Podpis</label>
                                                    <div class="wrapper">
                                                        <canvas
                                                                id="seller-signature-pad-<?= $i + 1 ?>"
                                                                class="signature-pad seller-pad"
                                                                width=400
                                                                height=200>
                                                        </canvas>
                                                    </div>
                                        ...
                                        <div
                                                ...
                                                id="kupujuci"
                                                role="tabpanel"
                                                aria-labelledby="kupujuci-tab"
                                        >
                                            <h5 class="m-b-10">Kupujúci č. 1</h5>
                                            <div class="row">
                                                <div class="col-md-12 form-group">
                                                    <label class="control-label">Typ majiteľa</label>
                                                    <select
                                            ...
                                            <div class="row ku-op-load-<?= $i + 1 ?> m-b-20">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input
                                                            type="file"
                                                            name="op_zadna"
                                                            id="op-zadna" class="form-control"
                                                    >
                                                </div>
                                            </div>
                                            <div class="row m-t-10 ku-op-load-<?= $i + 1 ?> m-b-40">
                                                <div class="col-md-12">
                                                    <button
                                                            ...
                                                            class="btn btn-secondary"
                                                            id="repr-op">
                                                        <i class="mdi mdi-upload"></i> Nahrať OP</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <select class="form-control select-drop" name="Dt[ku][][titp]">
                                                        <option value="">Zvoľte titul</option>
                                                        <?php foreach ($titul_pred as $titp) : ?>
                                                            <option value="<?= $titp['short_name']?>">
                                                                <?= $titp['short_name'] ?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <select class="form-control select-drop" name="Dt[ku][][titza]">
                                                        <option value="">Zvoľte titul</option>
                                                        <?php foreach ($titul_za as $titz) : ?>
                                                            <option value="<?= $titz['short_name']?>">
                                                                <?= $titz['short_name']?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                        ...
                                        <div
                                                ...
                                                id="splnomocnenec"
                                                role="tabpanel"
                                                aria-labelledby="splnomocnenec-tab"
                                        >
                                            <h5 class="card-title">Nahrajte OP splnomocnenca</h5>
                                            <div class="row m-t-10">
                                                <div class="col-sm-6">
                                                    <label for="op-predna" class="form-control-label">
                                                        Predná strana
                                                    </label>
                                                    <input
                                                            type="file"
                                                ...
                                                <div class="col-sm-6">
                                                    <label for="op-zadna" class="form-control-label">
                                                        Zadná strana
                                                    </label>
                                                    <input
                                                            type="file"
                                            ...
                                            <h5 class="card-title m-t-20">Údaje splnomocnenca</h5>
                                            <div class="row">
                                                <div class="col-md-6 form-group">
                                                    <label class="control-label">Email</label>
                                                ...
                                                <div class="col-md-1 form-group">
                                                    ...
                                                    <select class="form-control select-drop" name="Dt[sp][predv]">
                                                        <?php foreach ($predvolby as $pvo) : ?>
                                                            <option value="<?= $pvo['predvolba']?>">
                                                                +<?= $pvo['predvolba']?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                ...
                                                <div class="col-md-5 form-inline">
                                                    ...
                                                    <select
                                                            ...
                                                            name="Dt[sp][uto]"
                                                    >
                                                        <?php foreach ($uto as $uti) : ?>
                                                            <option value="<?= $uti['operator_kod']?>">
                                                                <?= $uti['operator_kod']?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <select class="form-control select-drop" name="Dt[sp][titp]">
                                                        <option value="">Zvoľte titul</option>
                                                        <?php foreach ($titul_pred as $titpe) : ?>
                                                            <option value="<?= $titpe['short_name']?>">
                                                                <?= $titpe['short_name'] ?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <select class="form-control select-drop" name="Dt[sp][titza]">
                                                        <option value="">Zvoľte titul</option>
                                                        <?php foreach ($titul_za as $titza) : ?>
                                                            <option value="<?= $titza['short_name']?>">
                                                                <?= $titza['short_name']?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    <div>
                                                        <div class="wrapper">
                                                            <canvas
                                                                    id="representative-signature-pad"
                                                                    class="signature-pad"
                                                                    width=400
                                                                    height=200>
                                                            </canvas>
                                        ...
                                        <div
                                                ...
                                                id="dodavatelia"
                                                role="tabpanel"
                                                aria-labelledby="dodavatelia-tab"
                                        >
                                                ...
                                                <tr class="col-md-12 form-group">
                                                    ...
                                                    <td>
                                                        <select class="form-control dropdown" name="Dt[dod][voda]">
                                                            ...
                                                            <?php foreach ($dodavatel_vody as $dv) : ?>
                                                                <option value="<?= $dv['id']?>">
                                                                    <?= $dv['name'] ?>
                                                                </option>}
                                                            <?php endforeach; ?>
                                                ...
                                                <tr class="col-md-12 form-group">
                                                    ...
                                                    <td>
                                                        <select class="form-control dropdown" name="Dt[dod][elek]">
                                                            <option value="0">Vyberte dodávateľa</option>
                                                            <?php foreach ($dodavatel_elektriny as $dode) : ?>
                                                                <option value="<?= $dode['id']?>">
                                                                    <?= $dode['name']?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                ...
                                                <tr class="col-md-12 form-group">
                                                    ...
                                                    <td>
                                                        <select class="form-control dropdown" name="Dt[dod][plyn]">
                                                            <option value="0">Vyberte dodávateľa</option>
                                                            <?php foreach ($dodavatel_plynu as $dodp) : ?>
                                                                <option value="<?= $dodp['id']?>">
                                                                    <?= $dodp['name'] ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                ...
                                                <tr class="col-md-12 form-group">
                                                    ...
                                                    <td>
                                                        <select class="form-control dropdown" name="Dt[dod][tvnet]">
                                                            <option value="0">Vyberte dodávateľa</option>
                                                            <?php foreach ($dodavatel_tv as $dtv) : ?>
                                                                <option value="<?= $dtv['id']?>">
                                                                    <?= $dtv['name'] ?>
                                                                </option>
                                                            <?php endforeach; ?>}
                                                ...
                                                <tr class="col-md-12 form-group">
                                                    ...
                                                    <td>
                                                        <select class="form-control dropdown" name="Dt[dod][tel]">
                                                            <option value="0">Vyberte dodávateľa</option>
                                                            <?php foreach ($dodavatel_telefon as $dit) : ?>
                                                                <option value="<?= $dit['id']?>">
                                                                <?= $dit['name'] ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                        ...
                                        <div
                                                ...
                                                id="financovanie"
                                                role="tabpanel"
                                                aria-labelledby="financovanie-tab"
                                        >
                                            <div class="row">
                                                <div class="col-md-12 form-group">
                                                    <label class="form-control-label">Financovanie</label>
                                                    <select class="form-control dropdown">
                                                        <option value="">Vyberte typ financovania</option>
                                                        <option value="hypo">Hypotéka</option>
                                                        <option value="cash">Vlastné zdroje - hotovosť</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 form-group">
                                                    <label class="form-control-label">Celková cena</label>
                                        ...
                                        <div
                                                ...
                                                id="preber-protokol"
                                                role="tabpanel"
                                                arial-labelledby="preber-protokol-tab"
                                        >
                                            Preberaci protokol
                                        </div>
                                    </form>
                                ...
                                <div class="modal-footer">
                                    <button
                                            type="button"
                                            class="btn btn-secondary"
                                            data-dismiss="modal">Zrušiť
                                    </button>
                                    <button
                                            type="button"
                                            class="btn btn-primary"
                                            id="save-other-data">Uložiť
                                    </button>
                                </div>
                            </div>
                        </div>
...
>
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="commentModalLabel">Komentár</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
