...
$this->registerCSSFile(
    'https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.3.1/jquery-confirm.min.css',
    [
        'depends' => RealAsset::class
    ]
);
$this->registerJSFile(
    'https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.3.1/jquery-confirm.min.js',
    [
        'depends' => RealAsset::class
    ]
);

$this->registerJSFile('@web/assets/fine-uploader/fine-uploader.min.js', ['depends' => RealAsset::class]);
$this->registerCSSFile('@web/assets/fine-uploader/fine-uploader.min.css', ['depends' => RealAsset::class]);
$this->registerCSSFile('@web/assets/fine-uploader/fine-uploader-gallery.min.css', ['depends' => RealAsset::class]);
$this->registerCSSFile('@web/assets/fine-uploader/fine-uploader-new.min.css', ['depends' => RealAsset::class]);
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <form
                    action="<?=Url::to(['contracts/save-makler-nehnutelnost'])?>"
                    method="post" enctype="multipart/form-data" id="form-makler">
                <input
                        id="form-token"
                        type="hidden"
                        name="<?=Yii::$app->request->csrfParam?>" value="<?=Yii::$app->request->csrfToken?>"/>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        <label class="control-label" for="zmluva-cislo">Číslo zákazky</label>
                                        <input
                                                type="text"
                                                class="form-control"
                                                name="Data[cislo]" value="<?= $contract_number ?>" id="zmluva-cislo">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <label class="control-label" for="main-agent">Maklér</label>
                                        <select
                                                class="form-control form-select"
                                                name="Data[agent][id]" id="main-agent" onchange="getComission()">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label class="control-label" for="main-comission">Stupeň</label>
                                        <?php
                                        $comission = 0;
                                        if (count($agents) == 1) {
                                        ...
                                        <input
                                                ...
                                                id="main-comission" value="<?= $comission ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label class="control-label" for="nehnut-druh">Druh nehnuteľnosti</label>
                    ...
                    <script type="text/template" id="qq-template-manual-trigger">
                        <div class="qq-uploader-selector qq-uploader" qq-drop-area-text="Drop files here">
                            ...
                            <div class="buttons">
                                ...
                                <button type="button" id="trigger-upload"
                                        class="btn btn-primary upload-trigger text-white">
                                    <i class="fa fa-upload"></i> Nahrať
                                </button>
                                <button
                                        type="button"
                                        id="trigger-remove" class="btn btn-danger text-white"
                            ...
                            <ul class="qq-upload-list-selector qq-upload-list"
                                aria-live="polite"
                                aria-relevant="additions removals" id="qq-upload-list">
                                <li>
                                    ...
                                    <img class="qq-thumbnail-selector" qq-max-size="100" qq-server-scale alt="">
                                    ...
                                    <button type="button"
                                            class="qq-btn qq-upload-cancel-selector qq-upload-cancel">Zrušiť</button>
                                    <button type="button"
                                            class="qq-btn qq-upload-retry-selector qq-upload-retry">Znovu</button>
                                    <button type="button"
                                            class="qq-btn qq-upload-delete-selector qq-upload-delete">Zmazať</button>
                                    <span role="status"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="table-identifikovany-majitelia"
                                       class="table color-table muted-table hover-table"
                                       style="margin-left: 10px; margin-right: 10px; margin-top: 10px; width: 99%">
                                </table>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <div class="card-body">
                            <button type="submit" class="btn btn-success text-white">
                                <i class="fa fa-arrow-circle-right"></i>&nbsp;Pokračovať</button>
                            <button type="button" class="btn btn-dark text-white"
                                    onclick="redirectTo('<?= Url::to(['/contracts'])?>')">
                                <i class="fa fa-times-circle"></i>&nbsp;Zrušiť
                            </button>
                        </div>
                    </div>
                </div>
