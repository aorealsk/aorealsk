...
$this->registerJSFile('@web/js/aoreal-storage.js?v=0.1',['depends'=>RealAsset::class]);
            ...
            <form action="<?=Url::to(['contracts/save-majitelia'])?>" method="post" id="form-majitelia">
                ...
                <div class="card">
                    <div class="form-actions">
                        <div class="card-body">
                            <button type="button" class="btn btn-info text-white" onclick="returnBack('form-majitel','<?= Url::to(['/contracts/property-info','id'=>$_GET['id']])?>')"><i class="fa fa-arrow-circle-left"></i> Späť</button>
