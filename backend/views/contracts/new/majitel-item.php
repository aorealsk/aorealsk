...
<div class="card customers"<?=$hideIt?> id="customer-<?= $i?>" data-id="<?= $i ?>">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12 form-group">
                <label class="control-label" for="op-note-<?= $i ?>">Pôvodný text na OP</label>
                <textarea class="form-control" id="op-note-<?= $i ?>" style="background-color: #f0f0f0; border: 1px dotted grey"></textarea>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 form-group">
                ...
                <textarea class="form-control" style="background-color: #f0f0f0; border: 1px dotted grey"><?= $zobraz ? $majitel['POPIS'] : "" ?></textarea>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 form-group">
                ...
                <select class="form-control select-drop to-store" onChange="zmen_zakaznika(<?= $i ?>)" name="Data[customer][<?= $i ?>][customer_type]" id="zmen-zakaznika-<?= $i ?>">
        ...
        <div class="row" id="obch-meno-<?=$i?>"<?= $zobraz && $majitel['OSOBA_TYP'] != 'PODN' ? " style='display:none'" : ""?>>
            <div class="col-md-12 form-group">
                ...
                <input id="obchodne-meno-<?= $i ?>" type="text" class="form-control to-store" name="Data[customer][<?= $i ?>][obchodne_meno]" value="<?= $zobraz && $majitel['OSOBA_TYP'] == 'PODN' ? $majitel['INFO']['NAZOV'] : ''?>">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <select class="form-select to-store" name="Data[customer][<?= $i ?>][lv_ac_deg_before]" id="lv-deg-before-<?=$i?>">
			...
			<div class="col-md-6 form-group">
                ...
                <select class="form-select to-store" name="Data[customer][<?= $i ?>][ac_deg_before]" id="deg-before-<?=$i?>">
                    <option value="">Zvoľte titul</option>
                    <?php
                    foreach($titul_pred as $item) {
                        echo "<option value='{$item['short_name']}'>{$item['short_name']}</option>";
		...
		<div class="row">
			<div class="col-md-6 form-group">
                ...
                <select class="form-select to-store" name="Data[customer][<?= $i ?>][lv_ac_deg_after]" id="lv-deg-after-<?= $i ?>">
                    <option value="">Zvoľte titul</option>
                    <?php
            ...
            <div class="col-md-6 form-group">
                ...
                <select class="form-select to-store" name="Data[customer][<?= $i ?>][ac_deg_after]" id="deg-after-<?= $i ?>">
                    <option value="">Zvoľte titul</option>
                    <?php
                    foreach($titul_za as $item) {
                        echo "<option value='{$item['short_name']}'>{$item['short_name']}</option>";
        ...
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <input type="text" id="lv-priezvisko-<?= $i ?>" class="form-control to-store" name="Data[customer][<?= $i ?>][lv_name_last]" value="<?= $zobraz ? $majitel['INFO']['PRIEZVISKO'] : ''?>"/>
            </div>
            <div class="col-md-6 form-group">
                <label class="control-label">Priezvisko na OP</label>
                <select id="priezvisko-<?= $i ?>" class="form-select to-store" name="Data[customer][<?= $i ?>][name_last]"></select>
            </div>
        </div>

        <div class="row">
            <div class="col-md-6 form-group">
                <label class="control-label" for="lv-meno-zakaznika-<?=$i?>">Meno na LV</label>
                <input type="text" class="form-control to-store" name="Data[customer][<?= $i ?>][lv_name_first]" id="lv-meno-zakaznika-<?=$i?>" value="<?= $zobraz ? $majitel['INFO']['MENO'] : '' ?>">
            </div>
            <div class="col-md-6 form-group">
        ...
        <div class="row">
			...
			<div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-2 p-0`">
                        <select class="form-select to-store" name="Data[customer][<?= $i ?>][predvolba]" id="predvolba-<?= $i ?>">
                            <?php
                    ...
                    <div class="col-2 p-0">
                        <select class="form-select to-store" name="Data[customer][<?= $i ?>][UTO]" id="uto-<?= $i ?>">
                            <?php
                            foreach ($uto as $item) {
                    ...
                    <div class="col-8">
                        <input type="text" class="form-control to-store" name="Data[customer][<?= $i ?>][cislo]" id="telefon-<?= $i ?>">
                    </div>
                </div>
            </div>
        </div>
