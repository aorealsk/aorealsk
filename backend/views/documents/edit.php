        ...
        <div class="card">
            <div class="card-body">
                <form method="post">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label class="control-label"><?= Yii::t('app','Názov pre exportovanie dokumentu') ?></label>
                            <input type="text" name="Dook[export_name]" class="form-control" value="<?= $template->export_name ?>">
                        </div>
                    </div>
                    <div class="row">
