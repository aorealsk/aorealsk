...
$this->title = Yii::t('app','Služby - nastavenia');
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <a href="<?= Url::to(['services/settings-add']) ?>" class="btn btn-danger text-white">
                        ...
                        <table class="table table-bordered table-striped table-sm dattable">
                            ...
                            <tr>
                                ...
                                <td><input
                                    ...
                                    ></td>
                                <td>
                                    <a href="<?= Url::to(['services/settings-edit','id'=>$service->id]) ?>" title="Edit" style="color: black"><i class="fas fa-pencil-alt"></i></a>
                                </td>
                            </tr>
