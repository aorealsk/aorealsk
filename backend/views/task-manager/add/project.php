                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="<?php echo Yii::$app->request->csrfParam ?>" value="<?php echo Yii::$app->request->getCsrfToken()?>">
                        <div class="form-group row mt-3">
                            ...
                            <div class="col-10">
                                <input type="text" class="form-control" name="TasksProject[name]">
                            </div>
                        </div>
                        <div class="form-group row mt-3">
                            <label class="col-2 col-form-label"><?= Yii::t('app','Kód projektu') ?></label>
                            <div class="col-10">
                                <input type="text" class="form-control" name="TasksProject[code]">
                            </div>
                        </div>
                        <div class="form-group row mt-3">
                            <label class="col-2 col-form-label"><?= Yii::t('app','Farba') ?></label>
                            <div class="col-10">
                                <input type="color" class="form-control" name="TasksProject[color]">
                            </div>
                        </div>
                        <div class="form-group row mt-3">
                            ...
                            <div class="col-10">
                                <select name="TasksProject[status]" class="form-select">
                                    <option value="1"><?= Yii::t('app','Aktívny') ?></option>
                                    <option value="0"><?= Yii::t('app','Neaktívny') ?></option>
                                </select>
                        </div>
                        <div class="row">
                            <div class="col-12">
