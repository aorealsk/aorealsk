                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                <select name="Invoice[mena]" class="form-select" id="faktura-mena">
                                    <?php
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                <select name="Invoice[forma_uhrady]" class="form-select" id="fu0">
                        ...
                        <div class="form-group row">
                            <label class="col-2 col-form-label">Zobraziť pečiatku:</label>
                            <div class="col-4">
