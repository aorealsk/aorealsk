...
<div class="form-group row">
    <div class="col-12">
        <select class="form-select" id="get-dodav">
            <option value=""></option>
            <?php
...
<div class="form-group row">
    ...
    <div class="col-3">
        <select name="Dodavatel[platca_dph]" class="form-select" id="dodavatel-vatpayer">
...
<div class="form-group row" id="db">
    ...
    <div class="col-9">
        <select name="Dodavatel[banka]" class="form-select" id="dodavatel-bank">
