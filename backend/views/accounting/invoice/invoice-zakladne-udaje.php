...
<div class="form-group row">
    ...
    <div class="col-5">
        <select name="Invoice[typ_faktury]" class="form-select" id="zalohovafa">
...
<div class="form-group row">
    ...
    <div class="col-5">
        <?php
        $vs = preg_replace('/[A-Z]+/','',$lastInvoiceNumber);
        ?>
...
<div class="form-group row">
    ...
    <div class="col-5">
        <select id="konst-symbol" name="Invoice[konst_symbol]" class="form-select">
            <?php
