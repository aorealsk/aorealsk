                                ...
                                <div class="form-group">
                                    ...
                                    <select name="PromoPlace[promo_id]" class="form-select">
                                        ...
                                        foreach ($promotions as $promotion) {
                                            $selected = $place->promo_id == $promotion->id ? ' selected' : '';
                                            echo "<option value='{$promotion->id}'{$selected}>" .
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input
                                            type="datetime-local"
                                            class="form-control"
                                            name="PromoPlace[finish_date]"
                                            value="<?= $place->finish_date ?>"
                                    >
                                </div>
                            </div>
                        </div>
