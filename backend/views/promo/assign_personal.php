...
$this->title = Yii::t('app', 'Pridať personál');
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="work_position">
                                        <option value="">Zvoľte...</option>
                                        <option value="hostess">Hostess/ka</option>
                                        <option value="promoter">Promoter/ka</option>
                                        <option value="casnik">Čašník/čka</option>
                                        <option value="barman">Barman/ka</option>
                                        <option value="kucharka">Kuchár/ka</option>
                                    </select>
                                </div>
                            </div>
                        </div>
